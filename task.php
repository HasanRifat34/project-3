...
if($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if(isset($_POST['task']) && !empty(trim($_POST['task']))){ 
        ...
        // Handle task deletion (check if a delete action is requested, remove the task from the array, and save)
        // delete a task
        ...
        // Handle task completion toggle (check if toggle action is requested, update task's done status, and save)
